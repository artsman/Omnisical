...
{
    ICAL_NO_WEEKDAY=0,
    ICAL_SUNDAY_WEEKDAY=1,
    ICAL_MONDAY_WEEKDAY=2,
    ICAL_TUESDAY_WEEKDAY=3,
    ICAL_WEDNESDAY_WEEKDAY=4,
    ICAL_THURSDAY_WEEKDAY=5,
    ICAL_FRIDAY_WEEKDAY=6,
    ICAL_SATURDAY_WEEKDAY=7
